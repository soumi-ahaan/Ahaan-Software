      ...
      <div className="container diagram">
        <svg viewBox="0 0 1100 640" xmlns="http://www.w3.org/2000/svg">
          ...
          <g>
            ...
            <text x="180" y="72" textAnchor="middle" fill="#ffffff" filter="url(#neon)" className="svgMonoText" style={{ fontSize: '16px' }}>10 contents creation per </text>
            <text x="180" y="92" textAnchor="middle" fill="#ffffff" className="svgMonoText" style={{ fontSize: '16px' }}>company per month</text>
          </g>
          ...
          <g>
            ...
            <text x="160" y="220" textAnchor="middle" fill="#ffffff" filter="url(#neon)" className="svgMonoText" style={{ fontSize: '14px' }}>Content planning</text>
          </g>
          ...
          <g>
            ...
            <text x="135" y="360" textAnchor="middle" fill="#ffffff" filter="url(#neon)" className="svgMonoText" style={{ fontSize: '14px' }}>Posting</text>
          </g>
          ...
          <g>
            ...
            <text x="172" y="502" textAnchor="middle" fill="#ffffff" filter="url(#neon)" className="svgMonoText" style={{ fontSize: '16px' }}>Performance reporting</text>
          </g>
          ...
          <g>
            ...
            <text x="928" y="72" textAnchor="middle" fill="#ffffff" filter="url(#neon)" className="svgMonoText" style={{ fontSize: '12.5px' }}>Social media management for HEW</text>
            <text x="928" y="92" textAnchor="middle" fill="#ffffff" className="svgMonoText" style={{ fontSize: '12.5px' }}>Motor, HEW Auto & HEW WORKS</text>
          </g>
          ...
          <g>
            ...
            <text x="928" y="216" textAnchor="middle" fill="#ffffff" filter="url(#neon)" className="svgMonoText" style={{ fontSize: '14px' }}>Comments engagement up to 15 to 30</text>
            <text x="928" y="238" textAnchor="middle" fill="#ffffff" className="svgMonoText" style={{ fontSize: '14px' }}>comments per post</text>
          </g>
          ...
          <g>
            ...
            <text x="905" y="360" textAnchor="middle" fill="#ffffff" filter="url(#neon)" className="svgMonoText" style={{ fontSize: '16px' }}>Solutions</text>
          </g>
          ...
          <g>
            ...
            <text x="916" y="502" textAnchor="middle" fill="#ffffff" filter="url(#neon)" className="svgMonoText" style={{ fontSize: '16px' }}>Weekly content update</text>
          </g>
